...
Small PHP + SQLite family shopping list app used to track items we need to get from a handful of stores. 
Runs as a webapp with persistence if no connection.
...
4. Update stores/ user colors in `/lib/bootstrap.php`.
